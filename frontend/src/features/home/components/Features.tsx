...
const FeatureCard = ({
  ...
  <div
    className={`relative overflow-hidden rounded-[2.5rem] group animate-fade-in-up ${delay} h-[450px]`}
  >
    <img
      src={
    ...
    <div className="absolute bottom-0 left-0 p-10 w-full">
      <div className="w-14 h-14 rounded-2xl glass flex items-center justify-center text-3xl mb-6 shadow-2xl transition-transform duration-500 group-hover:-translate-y-2">
        {icon}
      </div>
